...
#ifndef XPEREGUSERPREFERENCESTAB_H
#define XPEREGUSERPREFERENCESTAB_H

#include "pUserPreferencesTab.h"
#include "xperegUserPreferences.h"


class xperegUserPreferencesTab : public pUserPreferencesTab
{
...
#endif //XPEREGUSERPREFERENCESTAB_H

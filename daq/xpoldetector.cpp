...
const unsigned short xpoldetector::kPedSubDelayMin = 100;
const unsigned short xpoldetector::kPedSubDelayMax = 1000;
const unsigned short xpoldetector::kPedSubDelayStep = 50;
const unsigned short xpoldetector::kTrgEnableDelayMin = 50;
const unsigned short xpoldetector::kTrgEnableDelayMax = 500;
const unsigned short xpoldetector::kTrgEnableDelayStep = 50;
...
const unsigned short xpoldetector::kMaxWindowSizeMin = 1;
const unsigned short xpoldetector::kMaxWindowSizeMax = 5120;
const unsigned short xpoldetector::kMaxWindowSizeStep = 1;
const unsigned short xpoldetector::kClockFasterFreqCode = 0x0;
...
const unsigned short xpoldetector::kNumPixelsX = 388;
const unsigned short xpoldetector::kNumPixelsY = 336;
